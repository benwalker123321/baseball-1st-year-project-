		...
		/*-------------Image Gallery--------------*/
				...
				var logo = new Array("../Images/Leagues/Japan.jpg" , "../Images/Leagues/Britain.jpg" , "../Images/Leagues/Germany.jpg");  
				var thisLogo = 0; 

				function initLinks(){
										document.getElementById("previousLink").onclick = processPrevious;
				...
				function processPrevious(){
												...
												if (thisLogo == 0)
												{ 
													thisLogo = logo.length;
												}

										thisLogo--;
										document.getElementById("LeaguePicture").src = logo[thisLogo];
										return false; 
									}
